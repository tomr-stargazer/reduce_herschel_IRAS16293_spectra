...
def convert_FITS_to_HIFI(destination_folder, output_filename):
    ...
    try: 
        ...
        if not os.path.exists(output_fullpath):
            convert_fits_script_filename = write_class_script_to_convert_FITS_to_HIFI(destination_folder, fits_filename, output_filename)
            call(["class", "@"+convert_fits_script_filename])
...
if __name__ == "__main__":
    ...
    convert_FITS_to_HIFI(destination_folder, output_filename)
